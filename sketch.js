...
function setup()
{
 ...
 bytd = createSprite(width/1.95,height/8,20,20);
 bytd.rotation = bytd.rotation+90;
 bytd.addImage(bytdimage);
 bytd.scale = 1.3;   
...
function draw()
{
 ...
 if(gamestate === INT)
 {
  ...
  bytd.rotation = bytd.rotation-0.8;  
  bytd.scale = bytd.scale-0.01;  
  }
